...
% Usage : processVictorMelanpsin('G:\OneDrive - UAB - The University of Alabama at Birmingham\Victor\sorted\Victor_12_22_2020 1_4_MS.pl2');
%% extract the data

plexonStructure = prepPl2Data_2(dataPath);
% This function does all the preprocessing and data extraction into matlab
% spikes are in:
